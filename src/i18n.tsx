...
export const translations = {
  en: {
    ...
    brands: {
      ...
      paragraph2Featured: 'With a local hub located in Serdang, Selangor, Genus provides reliable, long-lasting power for everyday passenger cars as well as heavy-duty inverters and solar systems globally.',
      features: [
  ...
  zh: {
    ...
    brands: {
      ...
      paragraph2Featured: 'Genus 在雪兰莪沙登设有本地枢纽，为日常乘用车以及全球重型逆变器和太阳能系统提供可靠、持久的电力。',
      features: [
        ['钙银技术', '提升启动电力并延长整体寿命。'],
