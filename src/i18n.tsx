...
export const translations = {
  en: {
    ...
    home: {
      heroTitleTop: 'Trusted Automotive Battery',
      heroTitleAccent: 'Wholesaler',
      heroSubtitle: 'We supply high-performance automotive batteries for dealers, workshops, fleets, and retailers, with delivery, warranty, and installation support available.',
      ...
      services: [
        ...
        ['Expert Battery Delivery', 'Fast, reliable battery dispatch to workshops, dealers, fleets, retailers, and business locations during standard business hours.'],
        ['Installation Support', 'Installation support available for selected customers and vehicles, carried out by trained battery technicians.'],
        ['Battery Diagnostics', 'Battery testing and diagnostic support available to help workshops and customers confirm battery condition and charging performance.'],
      ...
      timelineDesc: 'Acquiring high-performance car batteries is straightforward. We make wholesale battery supply, delivery, warranty support, and optional installation assistance easy to manage.',
      steps: [
        ['Step 1: Inquiry & Quote', 'Send your battery requirements, vehicle application, or order quantity through our enquiry form or WhatsApp. We reply with competitive distributor pricing.'],
        ...
        ['Step 3: Delivery Dispatch', 'We arrange prompt delivery to your workshop, dealership, fleet location, retail outlet, or business address within our standard business hours.'],
        ['Step 4: Installation Support', 'Where installation support is required, our trained technicians can assist with safe battery fitting and basic charging-system checks.'],
      ...
      galleryTitle: 'Wholesale Supply, Delivery & Support',
      galleryDesc: 'Take an inside look at our inventory handling, battery delivery, product support, selected installation jobs, and wholesale distribution operations.',
      gallery: [
        ['Battery Installation Support', 'Preparing Genus batteries for a customer vehicle installation support job.'],
        ['Battery Support Checks', 'Battery and charging-system checks carried out as part of customer support.'],
        ...
        ['Secure AGM Battery Fitting', 'Genus AGM battery fitted securely as part of installation support.'],
    ...
    whyUs: {
      ...
      title: 'Why Dealers, Workshops & Fleets Choose GENUS',
      imageAlt: 'Automotive battery wholesale supply and customer support in Malaysia',
      ...
      reasons: [
        ['Wholesale Product Support', 'Our team supports dealers, workshops, and fleet customers with battery selection, product guidance, and installation assistance when needed.'],
        ['Competitive Dealer Pricing', 'We provide clear wholesale and dealer pricing with practical support for delivery, warranty, and selected installation services.'],
    ...
    brands: {
      ...
      featuredTitleLines: ['GENUS', 'BATTERIES'],
      featuredTagline: 'Power that drives you forward',
      ...
      paragraph2Featured: 'Genus Malaysia is dedicated to providing reliable automotive battery solutions that deliver dependable starting power, long service life, and peace of mind for everyday driving.',
      features: [
        ['Calcium-Silver Technology', 'Enhances cranking power and extends overall lifespan.'],
        ['Built To Last', 'Engineered with robust internal components for consistent performance and durability.'],
        ['Low Maintenance & Fast Charging', 'Engineered for convenience, deep discharge recovery, and rapid charge retention.'],
      ],
      featuredProducts: [
        ['EFB', 'SERIES', 'Superior starting power for modern vehicles with advanced electronics.', 'Genus EFB Series automotive battery'],
      ...
      whyChooseItems: [
        ...
        ['Dependable Everyday Performance', 'Built to provide stable starting power and consistent electrical performance for daily driving needs.'],
    ...
    faq: {
      ...
      desc: 'Find rapid answers to the most common inquiries regarding wholesale supply, delivery support, installation assistance, warranty procedures, and battery selection.',
      items: [
        ['How long does battery delivery take?', 'Delivery timing depends on stock availability, order quantity, and location. During standard business hours, we arrange dispatch as quickly as possible.'],
        ...
        ['Do you provide installation support?', 'Yes, installation support is available for selected customers and vehicle applications. Please contact us to confirm availability, location, and service requirements.'],
        ['What brands of car batteries do you have available?', 'We maintain stock of high-performance car battery lines including Genus, K-Viron, Bosch, Century, Amaron, and Varta. All units are fresh from production lines.'],
      ],
  ...
  zh: {
    ...
    home: {
      ...
      heroTitleAccent: '批发商',
      heroSubtitle: '我们为经销商、维修厂、车队和零售商供应高性能汽车电池，并提供配送、保修与安装支援。',
      ...
      services: [
        ...
        ['专业电池配送', '在标准营业时间内，将优质汽车电池快速可靠地配送到维修厂、经销商、车队、零售商与商业地点。'],
        ['安装支援', '可为指定客户与车辆提供安装支援，并由受训电池技术人员执行。'],
        ['电池检测', '提供电池测试与诊断支援，协助维修厂和客户确认电池状态与充电表现。'],
      ...
      timelineDesc: '采购高性能汽车电池非常简单。我们让批发电池供应、配送、保修支援与可选安装协助更容易安排。',
      steps: [
        ['步骤 1：询问与报价', '通过询问表格或 WhatsApp 发送您的电池需求、车辆应用或订购数量。我们会回复具竞争力的经销价格。'],
        ['步骤 2：订单准备', '仓库团队会仔细准备您的高性能 Genus 或 K-viron 电池，确保产品来自新鲜库存并完成测试。'],
        ['步骤 3：安排配送', '我们会在标准营业时间内，将电池配送到您的维修厂、经销点、车队地点、零售店或商业地址。'],
        ['步骤 4：安装支援', '如需要安装支援，我们的受训技术人员可协助安全安装电池，并进行基础充电系统检查。'],
        ['步骤 5：激活保修', '完成后，我们会激活您的官方 12 至 18 个月保修，保障长期可靠与安心。'],
      ],
      gallerySubtitle: '工作图库',
      galleryTitle: '批发供应、配送与支援',
      galleryDesc: '深入了解我们的库存处理、电池配送、产品支援、指定安装工作与批发配送运营。',
      gallery: [
        ['电池安装支援', '为客户车辆安装支援工作准备 Genus 电池。'],
        ['电池支援检测', '作为客户支援的一部分，进行电池与充电系统检查。'],
        ['Genus 与原厂电池对比', '将优质钙银 Genus AGM 电池与车辆原厂电池进行并排比较。'],
        ['AGM 电池稳固安装', '作为安装支援的一部分，稳固安装 Genus AGM 电池。'],
    ...
    whyUs: {
      ...
      badgeText: '批发供应商',
      subtitle: '我们的优势',
      title: '为什么经销商、维修厂与车队选择 GENUS',
      imageAlt: '马来西亚汽车电池批发供应与客户支援',
      overview: '在 GENUS MALAYSIA SDN BHD，我们是您值得信赖的汽车电池专家。我们专营高性能 Genus 和 K-viron 汽车电池，包括钙银技术与 EFB 玻璃纤维隔板技术，带来更持久的耐用表现。',
      reasons: [
        ['批发产品支援', '我们的团队为经销商、维修厂与车队客户提供电池选型、产品建议，并在需要时提供安装协助。'],
        ['具竞争力经销价格', '我们提供清晰的批发与经销价格，并为配送、保修和指定安装服务提供实际支援。'],
    ...
    brands: {
      ...
      featured: '精选品牌',
      genusTitle: 'Genus 电池',
      featuredTitleLines: ['GENUS', '电池'],
      featuredTagline: '驱动前行的可靠动力',
      ...
      paragraph2Featured: 'Genus Malaysia 致力于提供可靠的汽车电池解决方案，为日常驾驶带来值得信赖的启动动力、更长的使用寿命与安心保障。',
      features: [
        ['钙银技术', '提升启动电力并延长整体寿命。'],
        ['经久耐用', '采用坚固的内部组件设计，带来稳定性能与耐用表现。'],
        ['低维护与快速充电', '专为便利性、深度放电恢复与快速蓄电而设计。'],
      ],
      featuredProducts: [
        ['EFB', '系列', '为配备先进电子系统的现代车辆提供更强启动动力。', 'Genus EFB 系列汽车电池'],
      ...
      whyChooseItems: [
        ...
        ['可靠日常性能', '为日常驾驶需求提供稳定启动动力与一致的电气性能。'],
    ...
    faq: {
      subtitle: '有疑问？',
      title: '常见问题',
      desc: '快速了解有关批发供应、配送支援、安装协助、保修流程与电池选型的常见问题。',
      items: [
        ['电池配送需要多久？', '配送时间取决于库存情况、订购数量与地点。在标准营业时间内，我们会尽快安排发货。'],
        ['汽车电池是否提供保修？', '是的！所有电池都附有官方制造商保修。一般汽油车享有 12 至 18 个月现场保修，商用或柴油车辆则享有 6 至 12 个月保修。'],
        ['你们提供安装支援吗？', '是的，我们可为指定客户与车辆应用提供安装支援。请联系我们确认可用性、地点与服务需求。'],
        ['你们有哪些汽车电池品牌？', '我们备有高性能汽车电池系列，包括 Genus、K-Viron、Bosch、Century、Amaron 和 Varta。所有电池均来自新鲜生产库存。'],
      ],
